...
export const metadata: Metadata = {
	title: "Blog - ShortsStudio",
	description:
		"Read the latest news and updates about ShortsStudio, the free and open-source video editor.",
	openGraph: {
		title: "Blog - ShortsStudio",
		description:
			"Read the latest news and updates about ShortsStudio, the free and open-source video editor.",
...
export default async function BlogPage() {
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about ShortsStudio, the free and open-source video editor."
		>
