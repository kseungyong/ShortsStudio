...
export const metadata: Metadata = {
	title: "Changelog - ShortsStudio",
	description: "What's new in ShortsStudio",
	openGraph: {
		title: "Changelog - ShortsStudio",
		description: "Every update, improvement, and fix to ShortsStudio — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in ShortsStudio">
