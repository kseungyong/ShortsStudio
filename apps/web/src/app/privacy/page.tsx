...
export const metadata: Metadata = {
	title: "Privacy Policy - ShortsStudio",
	description:
		"Learn how ShortsStudio handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	openGraph: {
		title: "Privacy Policy - ShortsStudio",
		description:
			"Learn how ShortsStudio handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>
								ShortsStudio does not currently require an account or login
							</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ShortsStudio does not currently offer user accounts, login, or Google
					sign-in.
				</p>
				<p>
			...
			<section className="flex flex-col gap-3">
				...
				<p>ShortsStudio integrates with these services:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					<li>No account is required to use ShortsStudio today</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ShortsStudio is completely open source. You can review our code, see
