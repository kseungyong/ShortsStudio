...
export function Onboarding() {
	...
	const getStepTitle = () => {
		switch (step) {
			case 0:
				return "Welcome to ShortsStudio Beta! 🎉";
			case 1:
				return "⚠️ This is a super early beta!";
			case 2:
				return "🦋 Have fun testing!";
			default:
				return "ShortsStudio Onboarding";
		}
	};
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to ShortsStudio Beta! 🎉" />
							<Description description="You're among the first to try ShortsStudio - the Shorts-first browser video editor." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={`Join our [Discord](${SOCIAL_LINKS.discord}), chat with cool people and share feedback to help make ShortsStudio the best editor ever.`}
							/>
						</div>
